...
public class ProductMasterDaoImpl implements ProductMasterDao {
	...
	@Override
	public ProductMasterList add(ProductMasterList productMaster) throws CoronaException {
	...
	@Override
	public ProductMasterList save(ProductMasterList productMaster) throws CoronaException {
		if (productMaster != null) {
			try (Connection con = ConnectionFactory.getConnection();
	...
	@Override
	public List<ProductMasterList> getAll() throws CoronaException {
		
		List<ProductMasterList> products = new ArrayList<>();
		...
		try (Connection con = ConnectionFactory.getConnection();
			...
			while(rs.next()) {
				ProductMasterList pm = new ProductMasterList();
	...
	@Override
	public ProductMasterList getById(Integer productMasterId) throws CoronaException {
		
		ProductMasterList product=null;
